...
export function AssetSheet({ open, onClose, editItem, presetCategory, nameSuggestion }: Props) {
      ...
      >
        ...
        <div className="mx-auto max-w-md px-4 pt-2 pb-16">
          ...
          {presetCategory && !isEdit ? (
            <div className="mb-3">
              <span className="rounded-full bg-[#007aff]/10 px-3 py-1.5 text-xs font-semibold text-[#007aff]">
                {category}
              </span>
            </div>
          ) : (
